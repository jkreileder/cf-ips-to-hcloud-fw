...
4. Commit messages should follow the [Conventional Commits](https://www.conventionalcommits.org/en/v1.0.0/) style: `<type>[optional scope]: <description>`. For example:
